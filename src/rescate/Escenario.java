...
//				crearBonus();
		 	...
		 	try {
				Thread.sleep(300); //aca va un 1000
	...
	private void depurarElementos() {
		HelperEscenario.eliminarElementos(this);
	}
	...
	private void crearElementos() {
		...
		rHumano.setNivelEnergia(99);
		this.elementos.add(rHumano);
		
		//ROBOT QUE JODIDO
		RobotQueJodido robot1 = new RobotQueJodido(250, 320, this);
	...
	public void crearBonus() {
		  ...
		  if(this.bonusAleatorio==true){				  
			  int x = (int) (HelperEscenario.posicionAleatoriaX()*config.getAnchoTablero());
			  int y = (int) (HelperEscenario.posicionAleatoriaY()*config.getAltoTablero());
			switch (tipoBonus) {
				case 1:	
