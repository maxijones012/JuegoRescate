...
public class Radar implements RadarListener, JuegoListener{
	...
	private ArrayList<RadarListener> RadarListener ;//= new ArrayList<RadarListener>();
	private ArrayList<Elemento> listeners;//= 
	...
	public Radar(Elemento elemento){
		...
		this.listeners= new ArrayList<Elemento>();
   ...
   public void escanear(Elemento elemento){
	   ...
	   this.elementosVistos= elemento.getEscenario().detectarElementos(this);
